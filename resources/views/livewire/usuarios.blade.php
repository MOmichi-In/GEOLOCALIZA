                            ...
                            <td class="px-6 py-3 text-center">
                                <div class="flex justify-center gap-2">
                                    <button wire:click="editar({{ $usuario->id }})"
                                        class="text-gray-600 hover:text-gray-800 text-xl material-symbols-outlined rounded p-1 transition-colors duration-200">
                                        edit_note
                                    </button>

                                    <button wire:click="eliminar({{ $usuario->id }})"
                                        onclick="return confirm('¿Estás seguro?')"
                                        class="text-red-700 hover:text-red-900 text-xl material-symbols-outlined rounded p-1 transition-colors duration-200">
                                        delete
                                    </button>
            ...
            <div class="bg-white rounded-lg shadow-lg max-w-2xl w-full p-6 relative">
                ...
                <form wire:submit.prevent="guardar" class="space-y-4">
                    ...
                    <div class="flex justify-end gap-3 pt-4">
                        <button type="submit" class="bg-gray-500 hover:bg-gray-600 text-white px-5 py-2 rounded">
                            {{ $editando ? 'Actualizar Usuario' : 'Guardar Usuario' }}
                        </button>
                        <button type="button" wire:click="ocultarModal"
                            class="bg-red-700 hover:bg-red-700 text-white px-5 py-2 rounded">
                            Cancelar
                        </button>
                    </div>
                </form>
